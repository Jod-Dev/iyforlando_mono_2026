...
export class AuthMockApi {
    ...
    private _user: typeof userData = userData;

    /**
     * Constructor
     */
    constructor(private _fuseMockApiService: FuseMockApiService) {
        // Set the mock-api secret
        // ⚠️ NOTE: This is ONLY for mock/development. In production, use Supabase Auth.
        // This secret is NOT a real secret and is safe to commit for mock purposes.
        this._secret =
            'MOCK_SECRET_FOR_DEVELOPMENT_ONLY_NOT_FOR_PRODUCTION';
